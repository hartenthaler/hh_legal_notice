...
class LegalNoticeFooterModule extends PrivacyPolicy
    ...
    public const CUSTOM_RELEASE_DATE = '2026-06-15';
     ...
     */
    private function researchTypePrompts(): array
    {
        return [
     ...
     * @return array<string,string>
     */
    private function researchTypeDetailPreferences(): array
    {
        return [
     ...
     * @return array<string,string>
     */
    private function researchPurposeDescriptions(): array
    {
        $descriptions = [];
    ...
    private function researchPurposeDescription(string $researchSectionKey): string
    {
        ...
        $description = match ($researchSectionKey) {
            ...
            self::RESEARCH_SECTION_PLACE => I18N::translate('It deals with the research of all families and persons who lived in a particular place or region, regardless of their family names.'),
            self::RESEARCH_SECTION_FARM => I18N::translate('It deals with the research of farmsteads and their residents in a particular region, including the succession of farm owners and tenants over generations.'),
            self::RESEARCH_SECTION_TOPIC => I18N::translate('It deals with the research of persons connected by a common historical characteristic, such as membership of an institution, a profession, or a historical event.'),
