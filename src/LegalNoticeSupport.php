...
class LegalNoticeSupport
{
        ...
        // this sequence is the default order of chapters
    {
        return [
            ...
            'ResearchOfb'           => ['level' => 3, 'id' => 119, 'link' => 2, 'heading' => I18N::translate('One-place study or local family book')],
            'ResearchHoefe'         => ['level' => 3, 'id' => 120, 'link' => 2, 'heading' => I18N::translate('Farm and farmstead research')],
            'ResearchThema'         => ['level' => 3, 'id' => 121, 'link' => 2, 'heading' => I18N::translate('Thematic research')],
    ...
    public static function getChapterContent(string $hostingDomain, string $hostingCountry, bool $useEuPrivacyLaw, bool $useGermanPrivacyLaw): array
    {
        return [
            ...
            'ResearchOfb'           => ['contentIWe' => false, 'content'   => []],
            'ResearchHoefe'         => ['contentIWe' => false, 'content'   => []],
            'ResearchThema'         => ['contentIWe' => false, 'content'   => []],
