...
class LegalNoticeSupport
{
        ...
        // this sequence is the default order of chapters
    {
        return [
            ...
            'ResearchPlace'         => ['level' => 3, 'id' => 119, 'link' => 2, 'heading' => I18N::translate('One-place study or local family book')],
            'ResearchFarm'          => ['level' => 3, 'id' => 120, 'link' => 2, 'heading' => I18N::translate('Farm and farmstead research')],
            'ResearchTopic'         => ['level' => 3, 'id' => 121, 'link' => 2, 'heading' => I18N::translate('Thematic research')],
            'ResearchMigration'     => ['level' => 3, 'id' => 122, 'link' => 2, 'heading' => I18N::translate('Migration research')],
            'ResearchCommunity'     => ['level' => 3, 'id' => 123, 'link' => 2, 'heading' => I18N::translate('Community research')],
            'ResearchTest'          => ['level' => 3, 'id' => 127, 'link' => 2, 'heading' => I18N::translate('Test')],
            ...
            'DataExport'            => ['level' => 2, 'id' => 126, 'link' => 1, 'heading' => I18N::translate('Exporting data from webtrees')],
            'VersionChecks'         => ['level' => 2, 'id' => 128, 'link' => 1, 'heading' => I18N::translate('Version checks')],
            ...
            'SensitiveData'         => ['level' => 3, 'id' => 116, 'link' => 5, 'heading' => I18N::translate('Special categories of personal data')],
    ...
    {
        $textAndDataMiningNoticeI = $useGermanPrivacyLaw
            ? I18N::translate('The automated or systematic collection, scraping, and use of content from this website for text and data mining, including where a reservation of rights under Section 44b paragraph 3 UrhG is permissible, and for training or enriching artificial intelligence systems or for retrieval by such systems is prohibited without my prior written consent.')
            : I18N::translate('The automated or systematic collection, scraping, and use of content from this website for text and data mining, for training or enriching artificial intelligence systems, or for retrieval by such systems is prohibited without my prior written consent.');
        $textAndDataMiningNoticeWe = $useGermanPrivacyLaw
            ? I18N::translate('The automated or systematic collection, scraping, and use of content from this website for text and data mining, including where a reservation of rights under Section 44b paragraph 3 UrhG is permissible, and for training or enriching artificial intelligence systems or for retrieval by such systems is prohibited without our prior written consent.')
            : I18N::translate('The automated or systematic collection, scraping, and use of content from this website for text and data mining, for training or enriching artificial intelligence systems, or for retrieval by such systems is prohibited without our prior written consent.');
        ...
        return [
            ...
            'ResearchPlace'         => ['contentIWe' => false, 'content'   => []],
            'ResearchFarm'          => ['contentIWe' => false, 'content'   => []],
            'ResearchTopic'         => ['contentIWe' => false, 'content'   => []],
            'ResearchMigration'     => ['contentIWe' => false, 'content'   => []],
            'ResearchCommunity'     => ['contentIWe' => false, 'content'   => []],
            'ResearchTest'          => ['contentIWe' => false, 'content'   => []],
            ...
            'DataExport'            => ['contentIWe' => false, 'content'   => []],
            'VersionChecks'         => ['contentIWe' => false, 'content'   => []],
            ...
            'SensitiveData'         => ['contentIWe' => false, 'content'   => []],
            ...
            'DisputeResolution'     => $useEuPrivacyLaw
                ? ['contentIWe' => true,
                   'contentI' => [
                       $useGermanPrivacyLaw
                           ? I18N::translate('Consumer dispute resolution is available under Section 36 of the German Consumer Dispute Resolution Act (VSBG).')
                           : I18N::translate('Alternative dispute resolution mechanisms are available for consumer disputes in the European Union.'),
                       I18N::translate('I am not obliged and not willing to participate in dispute resolution proceedings before a consumer arbitration board.'),
                   ],
                   'contentWe' => [
                       $useGermanPrivacyLaw
                           ? I18N::translate('Consumer dispute resolution is available under Section 36 of the German Consumer Dispute Resolution Act (VSBG).')
                           : I18N::translate('Alternative dispute resolution mechanisms are available for consumer disputes in the European Union.'),
                       I18N::translate('We are not obliged and not willing to participate in dispute resolution proceedings before a consumer arbitration board.'),
                   ]]
                : [],
            ...
            'Copyright'             => ['contentIWe' => true,  'contentI'  => [I18N::translate('I always endeavor to observe the copyrights of others or to use self-created and license-free works. Third-party contributions to this website are marked as such by naming a source if they cannot be used freely. Should you nevertheless become aware of a copyright infringement, please inform me accordingly. As soon as I become aware of legal violations, I will remove such content immediately.'),
                                                                              ($hostingCountry == '' ?
                                                                               I18N::translate('The content and works created by me and the registered users on this website are subject to copyright. If you contribute content as a registered user of this website, you grant me an irrevocable, non-exclusive license to use this content. This is necessary because contributed information becomes part of a shared genealogical data collection that cannot practically be separated into individual contributions later.')
                                                                              :
                                                                              I18N::translate('The content and works created by me and the registered users on this website are subject to copyright in %s. If you contribute content as a registered user of this website, you grant me an irrevocable, non-exclusive license to use this content. This is necessary because contributed information becomes part of a shared genealogical data collection that cannot practically be separated into individual contributions later.',$hostingCountry)
                                                                              ),
                                                                               I18N::translate('The distribution and any kind of exploitation of the content of this website outside the limits of copyright require my written consent. Commercial use of the information provided here is generally prohibited.'),
                                                                               $textAndDataMiningNoticeI,
                                                                               I18N::translate('To reduce unwanted automated access, this website uses technical measures such as robots.txt rules and the webtrees Bad Bot Blocker. Access attempts may be recorded in the webtrees log and analyzed there. These measures supplement the legal notice but cannot guarantee complete protection.'),
                                                                               I18N::translate('I take the protection of copyright seriously. If I discover that copyrighted material from this website has been used contrary to these terms, I reserve the right to take legal action, including claims for damages, injunctive relief, and reimbursement of legal costs.'),
                                                               ...
                                                               'contentWe' => [I18N::translate('We always endeavor to observe the copyrights of others or to use self-created and license-free works. Third-party contributions to this website are marked as such by naming a source if they cannot be used freely. Should you nevertheless become aware of a copyright infringement, please inform us accordingly. As soon as we become aware of legal violations, we will remove such content immediately.'),
                                                                              ($hostingCountry == '' ?
                                                                               I18N::translate('The content and works created by us and by the registered users on this website are subject to copyright. If you contribute content as a registered user of this website, you grant us an irrevocable, non-exclusive license to use this content. This is necessary because contributed information becomes part of a shared genealogical data collection that cannot practically be separated into individual contributions later.')
                                                                              :
                                                                              I18N::translate('The content and works created by us and by the registered users on this website are subject to copyright in %s. If you contribute content as a registered user of this website, you grant us an irrevocable, non-exclusive license to use this content. This is necessary because contributed information becomes part of a shared genealogical data collection that cannot practically be separated into individual contributions later.',$hostingCountry)
                                                                              ),
                                                                               I18N::translate('The distribution and any kind of exploitation of the content of this website outside the limits of copyright require our written consent. Commercial use of the information provided here is generally prohibited.'),
                                                                               $textAndDataMiningNoticeWe,
                                                                               I18N::translate('To reduce unwanted automated access, this website uses technical measures such as robots.txt rules and the webtrees Bad Bot Blocker. Access attempts may be recorded in the webtrees log and analyzed there. These measures supplement the legal notice but cannot guarantee complete protection.'),
                                                                               I18N::translate('We take the protection of copyright seriously. If we discover that copyrighted material from this website has been used contrary to these terms, we reserve the right to take legal action, including claims for damages, injunctive relief, and reimbursement of legal costs.'),
